...
def get_table_schema(db_path: str, table_name: str):
    return _impl().get_table_schema(db_path, table_name)


def get_all_schemas(db_path: str):
    return _impl().get_all_schemas(db_path)


def format_schema_for_prompt(db_path: str) -> str:
    return _impl().format_schema_for_prompt(db_path)


def get_table_columns(db_path: str, table_name: str):
    return _impl().get_table_columns(db_path, table_name)
